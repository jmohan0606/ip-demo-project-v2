...
class Settings(BaseSettings):
    ...
    tigergraph_graph: str = Field(default="iperform_v2_revenue", alias="TIGERGRAPH_GRAPH")
    tigergraph_schema_prefix: str = Field(default="phx_dm_v2_", alias="TIGERGRAPH_SCHEMA_PREFIX")
