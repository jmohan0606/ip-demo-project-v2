...
ANOMALY = "phx_dm_v2_anomaly"
ANOMALY_SCAN = "phx_dm_v2_anomaly_scan"
CONVERSATION = "phx_dm_v2_conversation"
MESSAGE = "phx_dm_v2_message"
...
V2_VERTEX_TYPES = [
    ...
    COMMENTARY, COMMENTARY_EVALUATION, EVIDENCE, ANOMALY_SCAN, ANOMALY,
