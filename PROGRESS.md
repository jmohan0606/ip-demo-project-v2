...
| R-D | R13 | Env Health per-role probe uses the same corrected construction/call | IN_PROGRESS | 1eaee0b | probe corrected + verify_gpt5_compat 34/34; suites re-run PASS; ROUND13_ACCEPTANCE.md pending |
